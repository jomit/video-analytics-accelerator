### ( Original utility forked from [here](https://github.com/Azure/live-video-analytics/tree/master/utilities/rtspsim-live555) )
...
```powershell
    vlc rtsp://localhost:554/media/tentvideo.mkv
```
